    ...
    .controller('SigninCtrl', function ($scope, User, $location, $ionicPopup, $ionicLoading) {
       ...
       /*
        ...
        $scope.show = function(message) {
            $ionicLoading.show({
                template: '<div class="ionic loader"><svg class="circular"><circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"/></svg></div> <div>Signing In...</div>'
            });
        };
        //Hide function
        $scope.hide = function() {
